...
class AboutIteration(Koan):
    ...
    def test_reduce_will_blow_your_mind(self):
        ...
        # Extra Credit: Describe in your own words what reduce does. Reduce is composed of the following (Ts,
        # f(T, T) => T) a list of T and a binary function, f, from the set (T, T) to T.
        # If the list is larger than 1 then T1 and T2 are replaced with f(T1, T2) in the list.
        # repeat until the list is of size 1
